export type ProjectDomain = 'Web' | 'Backend' | 'Frontend' | 'Mobile' | 'System' | 'Game' | 'Network' | 'Network / Systems' | 'Systems / Security' | 'Game Development' | 'Web / Automation' | 'Functional Programming' | 'DevOps';
...
export const projects: Project[] = [
  {
    ...
    context: 'Academic',
    stack: ['C', 'Sockets', 'Networking', 'Concurrency'],
    image: 'https://images.unsplash.com/photo-1518770660439-4636190af475?q=80&w=1080',
    description: 'Multiplayer network game based on a client-server architecture.',
    problem: 'Design a real-time multiplayer game requiring efficient network communication and synchronization between multiple clients.',
    solution: 'Implemented a server handling multiple clients using sockets, managing game logic, synchronization, and communication protocols.',
    myRole: 'Developer responsible for network communication, server logic, and protocol handling.',
    //githubUrl: 'https://github.com/JeanMarcNaounou/zappy',
    //demoUrl: undefined,
    featured: true
  },
  {
    ...
    //githubUrl: 'https://github.com/JeanMarcNaounou/myftp',
    //demoUrl: undefined,
    featured: false
  },
  {
    ...
    //githubUrl: 'https://github.com/JeanMarcNaounou/mysudo',
    //demoUrl: undefined,
    featured: false
  },
  {
    ...
    context: 'Academic',
    stack: ['C++', 'OOP', 'Game Engine', 'Dynamic Libraries'],
    ...
    //githubUrl: 'https://github.com/JeanMarcNaounou/arcade',
    //demoUrl: undefined,
    featured: true
  },
  {
    ...
    context: 'Academic',
    stack: ['TypeScript', 'React', 'Node.js', 'REST API'],
    ...
    //githubUrl: 'https://github.com/JeanMarcNaounou/area',
    //demoUrl: undefined,
    featured: true
  },
  {
    id: '6',
    slug: 'glados-functional-ai',
    name: 'Glados',
    domain: 'Functional Programming',
    context: 'Academic',
    stack: ['Haskell'],
    image: 'https://images.unsplash.com/photo-1581091215367-59ab6b6a5b3e?q=80&w=1080',
    description: 'AI project implemented using functional programming concepts.',
    problem: 'Apply functional paradigms to AI logic and problem solving.',
    solution: 'Developed a functional architecture emphasizing immutability and pure functions.',
    myRole: 'Developer focused on functional logic and algorithm design.',
    //githubUrl: 'https://github.com/JeanMarcNaounou/glados',
    //demoUrl: undefined,
    featured: false
  },
  {
    ...
    //githubUrl: 'https://github.com/JeanMarcNaounou/whanos',
    //demoUrl: undefined,
    featured: true
  },
  {
    ...
    //githubUrl: 'https://github.com/JeanMarcNaounou/professionalwork',
    //demoUrl: undefined,
    featured: true
  }
